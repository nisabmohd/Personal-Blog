...
<Note>
  This is a simplified and rough implementation of `useRef`, meant only for
  learning purposes. The real React implementation involves internal
  optimizations and lifecycle management that aren’t covered here.
</Note>
