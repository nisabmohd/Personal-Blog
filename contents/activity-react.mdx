...
export default function App() {
  ...
  return (
    <>
      ...
      {video === 1 && <VideoPlayer key={1} src="https://somevideo1-url.mp4" />}
      {video === 2 && <VideoPlayer key={2} src="https://somevideo2-url.mp4" />}
    </>
  );
}
```
  ...
  return (
    <>
      ...
      <Activity mode={video === 1 ? "visible" : "hidden"}>
        <VideoPlayer key={1} src="https://somevideo1-url.mp4" />
      </Activity>
      <Activity mode={video === 2 ? "visible" : "hidden"}>
        <VideoPlayer key={2} src="https://somevideo2-url.mp4" />
      </Activity>
    </>
  );
}
